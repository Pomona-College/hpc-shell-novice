...
Series**, adapted from [The Unix Shell](https://swcarpentry.github.io/shell-novice/)
...
All examples in this workshop can be practiced on the Sagehen HPC cluster
via the OnDemand web terminal or SSH.
