...
The Unix shell for HPC users — files, pipes, loops and scripts. Adapted from Software Carpentry for the Sagehen HPC cluster at Pomona College.

**Lesson site:** <https://pomona-college.github.io/hpc-shell-novice/>

## About this lesson

This is Pomona College's adaptation of the Software Carpentry lesson
[The Unix Shell](https://swcarpentry.github.io/shell-novice/), reworked for researchers and
...
Adapted from [swcarpentry/shell-novice](https://github.com/swcarpentry/shell-novice) by
...
The original lesson is maintained by Gerard Capes, Jacob Deppen and Benson Muite, with contributions from many others. Please cite the original lesson as set out in `CITATION`.
...
[swcarpentry/shell-novice](https://github.com/swcarpentry/shell-novice) so the wider community
benefits.
